...
/**
 * @file icc_srgb.h
 * @brief Standard sRGB IEC61966-2.1 ICC profile for JPEG output.
 *
 * This is the canonical sRGB IEC61966-2.1 profile (the same one embedded
 * by Adobe Camera Raw). It uses the correct piecewise sRGB TRC with a
 * 1024-entry LUT, D65 white point, and all standard metadata tags.
 *
 * Size: 3144 bytes
 */
...
constexpr size_t SRGB_ICC_PROFILE_SIZE = 3144;

constexpr unsigned char SRGB_ICC_PROFILE[] = {
